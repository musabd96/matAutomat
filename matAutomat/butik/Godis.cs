                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        if (OrderGodis == 1)
                        {
                            ...
                            order1 = godis1.godisName + "  " + godis1.godisPrice + "kg/st * " +
                        ...
                        else if (OrderGodis == 2)
                        {
                            ...
                            order2 = godis2.godisName + "  " + godis2.godisPrice + "kg/st * " +
                        ...
                        else if (OrderGodis == 3)
                        {
                            ...
                            order3 = godis3.godisName + "  " + godis3.godisPrice + "kg/st * " +
                        ...
                        else if (OrderGodis == 4)
                        {
                            ...
                            order4 = godis4.godisName + "  " + godis4.godisPrice + "kg/st * " +
                        ...
                        else if (OrderGodis == 5)
                        {
                            ...
                            order5 = godis5.godisName + "  " + godis1.godisPrice + "kg/st * " +
                        ...
                        else if (OrderGodis == 6)
                        {
                            ...
                            order6 = godis5.godisName + "  " + godis6.godisPrice + "kg/st * " +
